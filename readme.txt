...
Usage
<?php if(function_exists('genarate_ajax_pagination')) genarate_ajax_pagination($btn_name, $color_name, $loop, $query );  ?>
...
5. Ajax callback function after complete next page is loaded  
...
Place `<?php if(function_exists('genarate_ajax_pagination')) genarate_ajax_pagination('Read More', 'blue');  ?>` after the main loop of the template.
...
3. Now we should add following variables to the 'genarate_ajax_pagination()' function.
    ...
    <?php if(function_exists('genarate_ajax_pagination')) genarate_ajax_pagination('Read More', 'blue', 'loop-magazine', array('post_type' => 'magazine')); ?>
